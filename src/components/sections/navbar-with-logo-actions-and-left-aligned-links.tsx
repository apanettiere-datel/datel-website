...
export function NavbarWithLogoActionsAndLeftAlignedLinks({
  ...
  return (
    <header className={clsx('sticky top-0 z-10 bg-mauve-100 dark:bg-mauve-950', className)} {...props}>
      ...
      <nav>
        <div className="mx-auto flex h-(--scroll-padding-top) max-w-[var(--layout-max-width)] items-center gap-4 px-6 lg:px-10">
        ...
        <ElDialog className="lg:hidden">
          <dialog id="mobile-menu" className="backdrop:bg-transparent">
            <ElDialogPanel className="fixed inset-0 bg-mauve-100 px-6 py-6 lg:px-10 dark:bg-mauve-950">
